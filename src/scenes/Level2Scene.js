...
export default class Level2Scene extends Phaser.Scene {
  ...
  preload() {
    preloadAssets(this, [
      'player', 'enemy',
      'pickup_sword', 'pickup_throwingstar', 'proj_star',
  ...
  _buildHUD() {
    this._hud = new HUD(this, 'LEVEL 2 — ANCIENT TEMPLE');
    ...
    this._enemyTxt = this.add.text(14, 78, 'Enemies: 4', {
  ...
  update(time, delta) {
    ...
    this._enemyTxt
      ...
      .setColor(liveCount > 0 ? '#ff6666' : '#ffcc44');
